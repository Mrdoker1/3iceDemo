          ...
          <div className="relative p-6">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-[#E63946] rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-[#E63946]/30">
                <Info size={24} strokeWidth={2.5} className="text-white" />
              </div>
              <div>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-[#E63946] to-[#c42a36] hover:from-[#ff4757] hover:to-[#E63946] text-white font-bold text-sm py-3 px-6 rounded-xl transition-all shadow-lg shadow-[#E63946]/30 hover:shadow-[#E63946]/50"
              >
                CONTACT US
              </motion.button>
            </a>
            ...
            <div className="mt-4 pt-4 border-t border-gray-700/50 flex items-center justify-center">
              <svg width="72" height="20" viewBox="0 0 144 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-50">
